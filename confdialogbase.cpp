...
**
** Created: Mi Sep 19 14:14:12 2012
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    ECTratioGroupBox = new QGroupBox( TabPage_3, "ECTratioGroupBox" );
    ECTratioGroupBox->setEnabled( TRUE );
    ECTratioGroupBox->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)5, (QSizePolicy::SizeType)1, 0, 0, ECTratioGroupBox->sizePolicy().hasHeightForWidth() ) );
    ECTratioGroupBox->setColumnLayout(0, Qt::Vertical );
    ECTratioGroupBox->layout()->setSpacing( 6 );
    ECTratioGroupBox->layout()->setMargin( 11 );
    ECTratioGroupBoxLayout = new QGridLayout( ECTratioGroupBox->layout() );
    ECTratioGroupBoxLayout->setAlignment( Qt::AlignTop );

    RatioSekECTLineEdit = new QLineEdit( ECTratioGroupBox, "RatioSekECTLineEdit" );
    RatioSekECTLineEdit->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)3, (QSizePolicy::SizeType)0, 0, 0, RatioSekECTLineEdit->sizePolicy().hasHeightForWidth() ) );
    RatioSekECTLineEdit->setMaximumSize( QSize( 75, 32767 ) );
    RatioSekECTLineEdit->setMaxLength( 9 );

    ECTratioGroupBoxLayout->addMultiCellWidget( RatioSekECTLineEdit, 1, 2, 1, 1 );

    RatioSekXLabel_3 = new QLabel( ECTratioGroupBox, "RatioSekXLabel_3" );
    ...
    ECTratioGroupBoxLayout->addWidget( RatioSekXLabel_3, 2, 0 );

    RatioPrimECTLineEdit = new QLineEdit( ECTratioGroupBox, "RatioPrimECTLineEdit" );
    RatioPrimECTLineEdit->setEnabled( TRUE );
    RatioPrimECTLineEdit->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)3, (QSizePolicy::SizeType)0, 0, 0, RatioPrimECTLineEdit->sizePolicy().hasHeightForWidth() ) );
    RatioPrimECTLineEdit->setMaximumSize( QSize( 75, 32767 ) );
    RatioPrimECTLineEdit->setMaxLength( 9 );

    ECTratioGroupBoxLayout->addWidget( RatioPrimECTLineEdit, 0, 1 );

    RatioPrimXLabel_3 = new QLabel( ECTratioGroupBox, "RatioPrimXLabel_3" );
    ...
    ECTratioGroupBoxLayout->addWidget( RatioPrimXLabel_3, 0, 0 );

    ectPrim_3radioButton = new QRadioButton( ECTratioGroupBox, "ectPrim_3radioButton" );

    ECTratioGroupBoxLayout->addMultiCellWidget( ectPrim_3radioButton, 0, 1, 2, 2 );

    ectSek_3radioButton = new QRadioButton( ECTratioGroupBox, "ectSek_3radioButton" );

    ECTratioGroupBoxLayout->addWidget( ectSek_3radioButton, 2, 2 );

    ectPrim_w3radioButton = new QRadioButton( ECTratioGroupBox, "ectPrim_w3radioButton" );

    ECTratioGroupBoxLayout->addMultiCellWidget( ectPrim_w3radioButton, 0, 1, 3, 3 );

    ectSek_w3radioButton = new QRadioButton( ECTratioGroupBox, "ectSek_w3radioButton" );

    ECTratioGroupBoxLayout->addWidget( ectSek_w3radioButton, 2, 3 );

    TabPageLayout_3->addWidget( ECTratioGroupBox, 1, 1 );
    ...
    connect( ectPrim_3radioButton, SIGNAL( clicked() ), this, SLOT( ectPrim_3radioButtonChecked() ) );
    connect( ectPrim_w3radioButton, SIGNAL( clicked() ), this, SLOT( ectPrim_w3radioButtonChecked() ) );
    connect( ectSek_3radioButton, SIGNAL( clicked() ), this, SLOT( ectSek_3radioButtonChecked() ) );
    connect( ectSek_w3radioButton, SIGNAL( clicked() ), this, SLOT( ectSek_w3radioButtonChecked() ) );
...
void ConfDialogBase::languageChange()
{
    ...
    Mode2RadioButton->setText( tr( "In/&ECT" ) );
    Mode2RadioButton->setAccel( QKeySequence( tr( "Alt+E" ) ) );
    Mode3RadioButton->setText( tr( "In/n&Convent" ) );
    Mode3RadioButton->setAccel( QKeySequence( tr( "Alt+C" ) ) );
    Mode0RadioButton->setText( tr( "In/&dIx" ) );
    Mode0RadioButton->setAccel( QKeySequence( tr( "Alt+D" ) ) );
    ...
    ECTratioGroupBox->setTitle( tr( "ECT" ) );
    RatioSekXLabel_3->setText( tr( "Sek:" ) );
    RatioPrimXLabel_3->setText( tr( "Prim:" ) );
    ectPrim_3radioButton->setText( tr( "/3" ) );
    ectSek_3radioButton->setText( tr( "/3" ) );
    ectPrim_w3radioButton->setText( tr( "/sqrt(3)" ) );
    ectSek_w3radioButton->setText( tr( "/sqrt(3)" ) );
