...
public:
    ...
    QWidget* TabPage_3;
    QGroupBox* ECTratioGroupBox;
    QLineEdit* RatioSekECTLineEdit;
    QLabel* RatioSekXLabel_3;
    QLineEdit* RatioPrimECTLineEdit;
    QLabel* RatioPrimXLabel_3;
    QRadioButton* ectPrim_3radioButton;
    QRadioButton* ectSek_3radioButton;
    QRadioButton* ectPrim_w3radioButton;
    QRadioButton* ectSek_w3radioButton;
...
protected:
    ...
    QGridLayout* ECTratioGroupBoxLayout;
