...
{
   Q3FileDialog *OETFileDialog=new Q3FileDialog ( wm3000iHome,tr("Eigenfehlertabellen (*.oet)"),this);
...
void WMViewBase::OpenResultFileSlot()
{
    ...
    ResultFileDialog->setDir(QDir(QString("%1%2").arg(wm3000iHome).arg("results")));
...
void WMViewBase::StoreResultSlot()
{
    if (m_ConfData.m_sResultFile=="") { // wir haben noch keine ergebnisdatei geöffnet
        QString s = Q3FileDialog::getSaveFileName(
                    QString("%1/wm3000i/%2").arg(wm3000iHome).arg("results/results.xml"),
        "Ergebnisdateien (*.xml)",
        this,
        "",
        "Ergebnisdateien" );
...
{
    SessionName = Q3FileDialog::getSaveFileName( QString("%1/wm3000i/%2").arg(wm3000iHome).arg("/Session.ses"),
                      tr("Sitzung Name (*.ses)"),
                      this,
                      "",
...
{
    Q3FileDialog *SessionFileDialog=new Q3FileDialog ( wm3000iHome,tr("Sitzung Name (*.ses)"),this);
...
{
    QString File = Q3FileDialog::getSaveFileName(QString("%1/wm3000i/%2").arg(wm3000iHome).arg("JData.xml"),
                    tr("Datei Name (*.xml)"),
                     this,
                    "",
...
{
    QString File = Q3FileDialog::getOpenFileName(QString("%1/wm3000i/%2").arg(wm3000iHome).arg("JData.xml"),
                     tr("Datei Name (*.xml)"),
                     this,
                     "",
