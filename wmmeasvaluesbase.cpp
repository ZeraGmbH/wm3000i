...
**
** Created: Mi Sep 19 15:34:03 2012
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    cBigLetter4 = new CBigLetter( this, "cBigLetter4" );
    cBigLetter4->setProperty( "m_nFrame", 0 );
    cBigLetter4->setProperty( "m_nStartSize", 15 );
    layout6->addWidget( cBigLetter4 );
    ...
    layout6->addWidget( mBigAngleName );
    ...
    layout7->addWidget( mBigLoadpointX );
    ...
    layout7->addWidget( mBigLoadpointN );
    ...
    layout7->addWidget( mBigAmplError );
    ...
    layout7->addWidget( mBigAngleError );
    WMMeasValuesBaseLayout->addLayout( layout7 );
    ...
    layout8->addWidget( mBigErrorUnit );
    ...
    layout8->addWidget( mBigAngleUnit );
    WMMeasValuesBaseLayout->addLayout( layout8 );
    languageChange();
    resize( QSize(637, 369).expandedTo(minimumSizeHint()) );
...
void WMMeasValuesBase::languageChange()
{
    ...
    cBigLetter4->setProperty( "m_sDisplay", tr( "LP(X):" ) );
