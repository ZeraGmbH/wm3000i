...
public slots:
    ...
    void ReceiveChannelNXOffsetResult(int);
    void ReceiveChannelNOffsetRequest();
    void ReceiveChannelXOffsetRequest();
...
signals:
    ...
    void RequestChannelNOffset();
    void RequestChannelXOffset();
