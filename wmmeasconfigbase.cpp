...
**
** Created: Mi Sep 19 15:33:53 2012
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    privateLayoutWidget->setGeometry( QRect( 11, 11, 671, 311 ) );
    layout4 = new QHBoxLayout( privateLayoutWidget, 11, 6, "layout4"); 

    groupBox40 = new QGroupBox( privateLayoutWidget, "groupBox40" );
    ...
    LPgroupBox = new QGroupBox( privateLayoutWidget, "LPgroupBox" );
    ...
    ErrgroupBox = new QGroupBox( privateLayoutWidget, "ErrgroupBox" );
    ...
    WgroupBox = new QGroupBox( privateLayoutWidget, "WgroupBox" );
    ...
    QWidget* privateLayoutWidget_2 = new QWidget( this, "layout48" );
    privateLayoutWidget_2->setGeometry( QRect( 11, 328, 671, 32 ) );
    layout48 = new QHBoxLayout( privateLayoutWidget_2, 11, 6, "layout48"); 
