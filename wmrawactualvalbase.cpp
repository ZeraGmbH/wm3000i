...
**
** Created: Mi Sep 19 14:16:44 2012
    ...
    : QDialog( parent, name, modal, fl )
{
    ...
    WMRawActualValBaseLayout->addItem( spacer17, 3, 3 );

    FreqDisp = new QLabel( this, "FreqDisp" );
    FreqDisp->setFrameShape( QLabel::NoFrame );

    WMRawActualValBaseLayout->addWidget( FreqDisp, 3, 2 );
    ...
    dXxPhaseDisp = new QLabel( this, "dXxPhaseDisp" );

    WMRawActualValBaseLayout->addWidget( dXxPhaseDisp, 2, 3 );

    dXxAmplDisp = new QLabel( this, "dXxAmplDisp" );

    WMRawActualValBaseLayout->addWidget( dXxAmplDisp, 2, 2 );
    ...
    XxLabel->setAlignment( int( QLabel::AlignVCenter | QLabel::AlignRight ) );

    WMRawActualValBaseLayout->addWidget( XxLabel, 1, 0 );

    FreqLabel = new QLabel( this, "FreqLabel" );
    FreqLabel->setFrameShape( QLabel::NoFrame );
    FreqLabel->setAlignment( int( QLabel::AlignVCenter | QLabel::AlignRight ) );

    WMRawActualValBaseLayout->addWidget( FreqLabel, 3, 0 );

    XnLabel = new QLabel( this, "XnLabel" );
    XnLabel->setFrameShape( QLabel::NoFrame );
    XnLabel->setAlignment( int( QLabel::AlignVCenter | QLabel::AlignRight ) );

    WMRawActualValBaseLayout->addWidget( XnLabel, 0, 0 );

    dXxLabel = new QLabel( this, "dXxLabel" );
    dXxLabel->setAlignment( int( QLabel::AlignVCenter | QLabel::AlignRight ) );

    WMRawActualValBaseLayout->addWidget( dXxLabel, 2, 0 );
    ...
    languageChange();
    resize( QSize(190, 151).expandedTo(minimumSizeHint()) );
...
void WMRawActualValBase::languageChange()
{
    ...
    dXxPhaseDisp->setText( tr( "---------" ) );
    dXxAmplDisp->setText( tr( "---------" ) );
    XxAmplDisp->setText( tr( "---------" ) );
    XxLabel->setText( tr( "Ix:" ) );
    FreqLabel->setText( tr( "F:" ) );
    XnLabel->setText( tr( "In:" ) );
    dXxLabel->setText( tr( "dIx:" ) );
