...
char* MModeName[maxMMode] = {"In/dIx","In/ECT","In/nConvent"};
...
void cWM3000SCPIFace::ResetDevice()
{
    ...
    m_ConfDataTarget.m_sRangeECTVorgabe = "15.0V";
...
void cWM3000SCPIFace::mSetRange(char* s)
{
	...
	case 2: sl = &m_sECTItemList; nrange = &m_ConfDataTarget.m_sRangeECTVorgabe;break;
	default: break;
	}
...
char* cWM3000SCPIFace::mGetRange()
{
    ...
    case 2: s = m_ConfDataActual.m_sRangeECT; break;
    default: break;
    }
...
char* cWM3000SCPIFace::mGetConfRatioEct()
{
    QString rs;
    m_ConfDataTarget = m_ConfDataActual;
    rs = QString("%1:%2").arg(m_ConfDataActual.m_ECTPrimary).arg(m_ConfDataActual.m_ECTSecondary);
...
void cWM3000SCPIFace::mSetConfRatioEct(char* s)
{
    ...
    {
	m_ConfDataTarget.m_ECTPrimary = sprim;
	m_ConfDataTarget.m_ECTSecondary = ssek;
//	emit SendConfiguration(&m_ConfData);
    }
}
...
void cWM3000SCPIFace::ExecuteCommand(int entryState) // ausführen eines common kommandos
{
	...
	m_ConfDataTarget.m_sRangeECTVorgabe = "Auto";
